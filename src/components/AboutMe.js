...
const AboutMe = () => {
  return (
    <div className='h-[50vh] px-3 bg-slate-50 flex items-center flex-col md:px-32'>

        <h1 className='text-xl font-textFont font-semibold text-slate-900 my-1 md:text-2xl md:my-3'>About Me </h1>
        <div className='flex items-center'>
      <span className='w-10 bg-amber-600 h-1 md:w-12'></span>  <ImUserTie className='text-2xl text-slate-900 mx-1 md:text-3xl'/><span className='w-12 bg-amber-600 h-1 md:w-12'> </span>
      </div>

      <p className='font-textFont md:text-xl md:text-center'>
