        ...
        <section className="flex flex-col justify-center items-center">
          ...
          <section className="social_media">
            <ul className="flex w-full justify-end mt-10">
              <li className="mr-2 w-8 h-8 flex items-center justify-center rounded-full border-slate-900  hover:bg-amber-600 cursor-pointer border-2 md:w-12 md:h-12 md:border-4 md:mr-5 dark:border-white">
